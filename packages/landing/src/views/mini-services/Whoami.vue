<template>
    <div class="whoami container">
        ...
        <BoxForm v-if="!result" submitButtonText="Ask who are you" @submit="fetchWhoami">
            <template v-slot:description>
                <div class="block">
                    <h4 class="title is-size-3">Description</h4>
                    <p class="block">This service will tell who you - deeply inside - really are</p>
                    <h5 class="title is-size-5">Endpoint:</h5>
                    <code> /api/whoami </code>
                </div>
            </template>

            <template v-slot:preview>
                <div class="timestamp__preview" v-if="response">
                    <h6 class="title is-6 block">This is who you are. Surprise!</h6>
