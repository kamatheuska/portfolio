<template>
  <div class="geometric-concertos container">
    <div class="geometric-concertos__concertos">
      ...
      <template v-if="!fine">
        <div
          v-for="(concerto, concertoName, concertoIndex) in squareConcertos"
...
export default {
  ...
  methods: {
    ...
    generateSquareForIndex(index) {
      ...
      const {
        height, top, left, color,
      } = this.generateSquareDetails(ranges);
      return new Square({
        height,
        top,
        left,
