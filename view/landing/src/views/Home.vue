            ...
            return [
                {
                    ...
                    imageSrc: `${this.$env.PORTFOLIO_BUCKET}/images/wordpress-logo__b&w.png`,
                    hasSmallImage: true,
                    animateOnHover: true,
                },
                {
                    ...
                    imageSrc: `${this.$env.PORTFOLIO_BUCKET}/images/blogger-logo__b&w.png`,
                    hasSmallImage: true,
                    animateOnHover: true,
                },
                {
                    ...
                    imageSrc: `${this.$env.PORTFOLIO_BUCKET}/images/soundcloud-logo__b&w.png`,
                    hasSmallImage: true,
                    animateOnHover: true,
                },
            ];
